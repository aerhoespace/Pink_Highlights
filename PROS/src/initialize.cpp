...
void initialize() {
  ...
  //setup motors
  pros::Motor leftFront  (11, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_DEGREES); //all of these take additional conditions check: https://pros.cs.purdue.edu/v5/tutorials/topical/motors.html
  ...
  //setup motors
  pros::Motor left (11, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_DEGREES);//11th port 
